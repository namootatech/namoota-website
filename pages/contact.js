...
const CTAContent = ({ hint, title, link1, link2 }) => (
  <div class='bg-sky-700 py-6 sm:py-8 lg:py-12'>
...
export default function Home() {
  const [selected, setSelected] = useState('website-or-landing-page');
    ...
    <>
      ...
      >
        <div class='grid lg:grid-cols-2 items-center gap-14 sm:p-8 p-4 font-[sans-serif]'>
          <div>
            <h1 class='text-4xl font-bold text-sky-700'>Get in Touch</h1>
            <p class='text-2xl text-gray-500 mt-4 leading-relaxed'>
          ...
          <div class='relative bg-gray-100 p-6 rounded-lg'>
            {success && (
              <div class='fixed top-10 m-4 left-0  flex w-full max-w-sm overflow-hidden bg-white rounded-lg shadow-md dark:bg-gray-800'>
