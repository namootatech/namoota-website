...
const Testimonials = () => {
  const testimonials = [
    ...
    },
    {
      ...
      name: 'Vanessa Ackermans',
      title: 'Product designer',
      quote:
        'One day, my company was about to go under and I had no idea what to do. I found Namoota and it helped me get my business back on track.Now, my company is flourishing and I see new opportunities.',
    },
    {
      avatar:
    ...
    },
    {
      ...
      name: 'Lonwabo Sithole',
      title: 'Full stack engineer',
      quote:
        'We all know how costly it is to find good help. I was faced with this problem when I lost my data entry staff and my business was on the brink of going under. Thankfully, Namoota saved the day.',
    },
  ];
