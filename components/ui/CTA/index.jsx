  ...
  return (
    <section class='relative pt-32 lg:pt-36 -mx-24 '>
      <div class='mx-auto lg:max-w-7xl w-full px-5 sm:px-10 md:px-12 lg:px-5 flex flex-col lg:flex-row gap-10 lg:gap-12'>
        ...
        <span class='w-4/12 lg:w-2/12 aspect-square bg-gradient-to-tr from-blue-600 to-sky-400 absolute -top-5 lg:left-0 rounded-full skew-y-12 blur-2xl opacity-40 skew-x-12 rotate-90'></span>
        <div
